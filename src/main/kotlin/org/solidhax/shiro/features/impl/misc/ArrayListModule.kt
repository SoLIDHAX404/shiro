...
object ArrayListModule : Module(
    ...
    private val hud: HudElement by HUD("Array List", "Shows all enabled modules on screen.", toggleable = false) { example ->
        ...
        names.forEachIndexed { index, name ->
            ...
            if (background) roundedRectangle(lineX, y, lineWidth, LINE_HEIGHT, BACKGROUND, Radius.MEDIUM)
            if (accentBar) accentEdge(lineX, y, lineWidth, LINE_HEIGHT, Radius.MEDIUM, textColor, left = !rightAligned)
